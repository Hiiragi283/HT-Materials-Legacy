...
object HTElements {
	...
	@JvmField
	val Ni = HTElement.of(
		averageColor(HTColor.GOLD to 2, HTColor.GRAY to 3, HTColor.GREEN to 1, HTColor.WHITE to 2),
		"Ni",
		58.7,
	)
	...
	@JvmField
	val OH = HTElement.group(O to 1, H to 3)

	@JvmField
	val CO3 = HTElement.group(C to 1, O to 3)

	@JvmField
	val NO3 = HTElement.group(N to 1, O to 3)
	...
	@JvmField
	val PO4 = HTElement.group(P to 1, O to 4)
