...
public abstract class HTMaterialFlags {
    ...
    public static final HTMaterialFlag NOT_GENERATE_FLUID = HTMaterialFlag.create("not_generate_fluid",
            builder -> builder.requiredProperties.add(HTPropertyKeys.FLUID));
}
