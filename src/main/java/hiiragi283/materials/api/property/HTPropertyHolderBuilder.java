...
public final class HTPropertyHolderBuilder {
  ...
  @NotNull private final Map<HTPropertyKey<?>, Object> delegatedMap;
  ...
  public <T> @NotNull HTPropertyHolderBuilder put(
      @NotNull final HTPropertyKey<T> key, @NotNull final T value) {
